...
public class QueryOracle {
    ...
    public ArrayList Periodo(String entidad) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select UNIQUE(PERIODO)PERIODO FROM RES_TMP_SENAP_CARPETAINVESTIGACION "
    ...
    public ArrayList PeriodoTR(String entidad) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select UNIQUE(PERIODO)PERIODO FROM RES_TR_SENAP_CARPETAINVESTIGACION "
                + " WHERE ENTIDADID='" + entidad + "' ";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
    ...
    public void Inserta_RES_tr_senap_Control(String entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        sql = "INSERT INTO RES_TR_SENAP_CONTROL (ENTIDADID,TOTAL_CARPETA_INVESTIGACION,TOTAL_VICTIMAS,TOTAL_IMPUTADOS,TOTAL_DELITOS,TOTAL_DETERMINACIONES,PERIODO,ESTATUS) VALUES ('" + entidad + "',(SELECT COUNT(*) FROM TMP_SENAP_CARPETAINVESTIGACION WHERE ENTIDADID='" + entidad + "' AND PERIODO='" + Periodo + "'),"
    ...
    public void Limpia_RES_tr_senap_Control(String entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        sql = "DELETE FROM RES_TR_SENAP_CONTROL  WHERE ENTIDADID='" + entidad + "' AND PERIODO='" + Periodo + "'";
        System.out.println(sql);
        conexion.escribir(sql);
        conexion.close();
    }

    public void Actualiza_Estatus_RES_tr_senap_Control(String entidad, String Periodo, String Estatus) throws SQLException {
        conexion.Conectar();
        sql = "UPDATE  RES_TR_SENAP_CONTROL SET ESTATUS='" + Estatus + "' WHERE ENTIDADID='" + entidad + "' AND PERIODO='" + Periodo + "'";
        System.out.println(sql);
        conexion.escribir(sql);
        conexion.close();
    }
    ...
    public void Actualiza_Estatus_Validacion(String entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        sql = "UPDATE RES_TR_SENAP_CONTROL SET ESTATUS='En Validacion' WHERE ENTIDADID='" + entidad + "' AND PERIODO='" + Periodo + "'";
        System.out.println(sql);
        conexion.escribir(sql);
        conexion.close();
    }
    ...
    public String Estatus_Control(String entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        String Est = "";
        sql = "Select ESTATUS FROM  RES_TR_SENAP_CONTROL  WHERE ENTIDADID='" + entidad + "' AND PERIODO='" + Periodo + "'";
        resul = conexion.consultar(sql);
        System.out.println(sql);
        try {
            if (resul.next()) {
