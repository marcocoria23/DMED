...
public class VCarpetaInvetigacion {
    ...
    public ArrayList NOTICIACRIMINALID(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select \n"
                ...
                + "ci.DIRECCIONUBICACIONID,ci.DETERMINACIONID_ULTIMO,nc.NOTICIACRIMINALID as otro from RES_tr_senap_carpetainvestigacion CI inner join RES_tr_senap_noticiacriminal nc\n"
    ...
    public ArrayList FECAPECARINVE(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select \n"
                ...
                + "inner join RES_tr_senap_noticiacriminal nc\n"
    ...
    // prioridad 1
    //ReglaNegocio 2.3. En caso de que la Fecha de apertura de la carpeta de investigación FECHAPECARINVE sea igual a la Fecha de la presentación de la denuncia o querella FECHAPRESDENUNQUERELLA (RES_TR_SENAP_NOTICIACRIMINAL), en caso de existir, la Hora de la apertura de la carpeta  HORAPECARINVE deberá ser mayor a la hora de la denuncia o querella HORAREPREDENUNQUERELLA de la plantilla de noticia criminal (RES_TR_SENAP_NOTICIACRIMINAL).
    ...
    public ArrayList DELITOS(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "from RES_tr_senap_delitos group by ENTIDADID, CARPETAID, PERIODO) deli on deli.ENTIDADID=ci.ENTIDADID and deli.CARPETAID=ci.CARPETAID and deli.PERIODO=ci.PERIODO\n"
                + "))\n"
    ...
    public ArrayList VICTIMAS(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "from RES_tr_senap_victimas group by ENTIDADID, CARPETAID, PERIODO) vic on vic.ENTIDADID=ci.ENTIDADID and vic.CARPETAID=ci.CARPETAID and vic.PERIODO=ci.PERIODO\n"
                + "))\n"
    ...
    public ArrayList FECHACARINVEMayor(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "SELECT ENTIDADID,CARPETAID,PERIODO\n"
                + "FROM RES_TR_SENAP_CARPETAINVESTIGACION\n"
    ...
    //ReglaNegocio 2.10. Tipo de atención CATTIPOATENCIONID (RES_TR_SENAP_ATENCIONES), Fecha de inicio de la atención FECHAINICIOATENCION (RES_TR_SENAP_ATENCIONES), Fecha de conclusión de la atención FECHCONCLUATE (RES_TR_SENAP_ATENCIONES) y Sentido de la conclusión de la atención CATSENTCONCLUATEID (RES_TR_SENAP_ATENCIONES) no podrán estar vacías si el campo “En caso de no abrir carpeta de investigación, ¿Se brindó algún tipo de atención?” BRINDOALGUNTIPOATENCION es requisitado con la opción
    public ArrayList CATTIPOATENCIONID(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "SELECT ate.ENTIDADID,ate.ATENCIONID,ate.NOTICIACRIMINALID,ate.NOTICIACRIMINALID_FISCALIA,ate.PERIODO,\n"
                ...
                + " FROM RES_TR_SENAP_ATENCIONES ATE INNER JOIN RES_TR_SENAP_NOTICIACRIMINAL NC \n"
    ...
    //ReglaNegocio 2.10.1. Tipo de atención CATTIPOATENCIONID (RES_TR_SENAP_ATENCIONES), Fecha de inicio de la atención FECHAINICIOATENCION (RES_TR_SENAP_ATENCIONES), Fecha de conclusión de la atención FECHCONCLUATE (RES_TR_SENAP_ATENCIONES) y Sentido de la conclusión de la atención CATSENTCONCLUATEID (RES_TR_SENAP_ATENCIONES) no podrán traer valor si el campo “En caso de no abrir carpeta de investigación, ¿Se brindó algún tipo de atención?” BRINDOALGUNTIPOATENCION es la opción “No”
    ...
    public ArrayList ACTOS(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select \n"
                ...
                + "AI.REG\n"
                + "from RES_TR_SENAP_CARPETAINVESTIGACION CI\n"
                + "LEFT JOIN (SELECT ENTIDADID, PERIODO,CARPETAID, COUNT (CARPETAID) AS REG FROM RES_TR_SENAP_ACTOSINVESTIGACION GROUP BY ENTIDADID, PERIODO,CARPETAID) AI ON  \n"
    ...
    public ArrayList IMPUTADOS(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "from RES_tr_senap_imputado group by ENTIDADID, CARPETAID, PERIODO) imp on imp.ENTIDADID=ci.ENTIDADID and imp.CARPETAID=ci.CARPETAID and imp.PERIODO=ci.PERIODO\n"
                + "))\n"
    ...
    public ArrayList NCDELITOS(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select \n"
                ...
                + "de.reg\n"
                + "from RES_TR_SENAP_CARPETAINVESTIGACION CI\n"
                + "LEFT JOIN (SELECT ENTIDADID, PERIODO,CARPETAID, COUNT (CARPETAID) AS REG FROM RES_TR_SENAP_DELITOS GROUP BY ENTIDADID, PERIODO,CARPETAID) DE ON de.entidadid=ci.entidadid and de.periodo=ci.periodo and ci.CARPETAID=de.carpetaid\n"
                + "\n"
    ...
    public ArrayList ACTOSINVESTIGACION(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select * from (\n"
                ...
                + "ain.reg\n"
                + "from RES_TR_SENAP_CARPETAINVESTIGACION  CI \n"
                + "left join(SELECT ENTIDADID, PERIODO,CARPETAID, COUNT (CARPETAID) AS REG FROM RES_TR_SENAP_ACTOSINVESTIGACION GROUP BY ENTIDADID, PERIODO,CARPETAID) AIN\n"
